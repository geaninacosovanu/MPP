...
public class InscriereServerAMSProxy implements IInscriereServiceAMS {
    private String host;
    private int port;
    ...
    public InscriereServerAMSProxy(String host, int port) throws InscriereServiceException {
        this.host = host;
        this.port = port;
    ...
    @Override
    public void logout(User u) throws InscriereServiceException {
    ...
    @Override
    public boolean login(String username, String parola) throws InscriereServiceException {
