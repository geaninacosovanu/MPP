...
public class InscriereClientAMSWorker implements Runnable {
    ...
    public InscriereClientAMSWorker(IInscriereServiceAMS service, Socket connection) {
    ...
    private Response handleRequest(Request request) {
        ...
        if (request.getType() == RequestType.LOGIN) {
            ...
            boolean exists;
            try {
                exists = service.login(user.getId(), user.getParola());
