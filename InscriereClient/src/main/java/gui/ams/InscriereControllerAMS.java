...
public class InscriereControllerAMS implements INotificationSubscriber {
    ...
    public void setService(IInscriereServiceAMS service, User user) {
        this.user=user;
    ...
    @Override
    public void notificationReceived(notification.Notification notification) {
//        try {
